...
from attattr.bert.tokenization import BertTokenizer
from attattr.bert.modeling_orig import BertForSequenceClassification
from attattr.bert.optimization import BertAdam
from attattr.classifier_processer import InputExample, InputFeatures, DataProcessor, MnliProcessor
...
def main():
    ...
    model_state_dict = torch.load(args.model_file, map_location=torch.device(device))
